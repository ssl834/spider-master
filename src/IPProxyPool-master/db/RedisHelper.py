...
class RedisHelper(ISqlHelper):
    def __init__(self, url=None,proxy_type='FREE'):
        self.index_names = ('types', 'protocol', 'proxy_type' 'score')
        self.redis_url = url or config.DB_CONFIG['PROXY_TYPE'][proxy_type]['DB_CONNECT_STRING']
