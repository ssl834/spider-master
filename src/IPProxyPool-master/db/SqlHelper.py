...
class SqlHelper(ISqlHelper):
    ...
    def __init__(self):
        if 'sqlite' in DB_CONFIG['FREE']['DB_CONNECT_STRING']:
            connect_args = {'check_same_thread': False}
            self.engine = create_engine(DB_CONFIG['FREE']['DB_CONNECT_STRING'], echo=False, connect_args=connect_args)
        else:
            self.engine = create_engine(DB_CONFIG['FREE']['DB_CONNECT_STRING'], echo=False)
